...
export const metadata: Metadata = {
  title: 'Thermax\'s Agentic AI Operating System 2030',
  description:
      ...
      <body className="font-sans min-h-screen flex flex-col">
        ...
        <footer className="border-t border-thermax-line bg-white">
          <div className="max-w-7xl mx-auto px-6 py-5 text-xs text-thermax-slate flex flex-wrap items-center justify-between gap-2">
            <span>
              Thermax's Agentic AI Operating System 2030 · Enterprise LLM · Designed &amp; Developed by Harsha Rao | Director - AI Strategy &amp; Consulting | Regenesys School of AI
            </span>
