...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    sampleFiles: [
      { filename: 'senior_engineer_jd.txt', label: 'JD — Senior Boiler Engineer', description: 'Job Description for Senior Engineer (Boiler Design) — responsibilities, qualifications, certifications, competencies. Use with CV for comparison.', path: '/sample-data/doc-intelligence/hr/senior_engineer_jd.txt' },
      { filename: 'candidate_cv_boiler_engineer.txt', label: 'CV — Candidate for Boiler Engineer', description: 'Candidate resume for the Senior Engineer (Boiler Design) role — education, experience, skills, certifications. Use with JD for comparison.', path: '/sample-data/doc-intelligence/hr/candidate_cv_boiler_engineer.txt' },
  ...
  },
  {
    ...
    sampleFiles: [
      { filename: 'thermax_standard_nda.txt', label: 'Thermax Standard NDA', description: 'Thermax standard mutual NDA template — balanced terms, Indian law, Pune jurisdiction, 5-year obligation period. Use with customer NDA for comparison.', path: '/sample-data/doc-intelligence/legal/thermax_standard_nda.txt' },
      { filename: 'customer_proposed_nda.txt', label: 'Customer Proposed NDA', description: 'Customer-proposed NDA with non-standard terms — broader scope, non-compete clause, unlimited liability, Singapore law, SIAC arbitration. Use with Thermax NDA for comparison.', path: '/sample-data/doc-intelligence/legal/customer_proposed_nda.txt' },
      { filename: 'nda_template.txt', label: 'NDA Template (Legacy)', description: 'Standard Thermax mutual NDA — parties, scope, obligations, exclusions, term, remedies, jurisdiction', path: '/sample-data/doc-intelligence/legal/nda_template.txt' },
