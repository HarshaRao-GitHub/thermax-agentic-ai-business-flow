...
export const sampleFilesByStage: Record<string, SampleFile[]> = {
  ...
  presales: [
    ...
    { filename: 'ril_remin_bom.txt', label: 'RIL Remin BOM (632 items)', description: 'Full Bill of Materials for RIL Remineralization project — 10 categories (rotary, electrical, instrumentation, valves, piping, structurals), MOC details, lead times, for presales costing reference', path: '/sample-data/presales/ril_remin_bom.txt', fileType: 'txt' },
    { filename: 'ril_remin_bom.csv', label: 'RIL Remin BOM (Raw CSV)', description: 'Complete 632-row hierarchical BOM with 48 columns — item codes, descriptions, UOM, quantities, supply types, work orders, effectivity dates', path: '/sample-data/presales/ril_remin_bom.csv', fileType: 'csv' },
  ],
  'engineering-design': [
    ...
    { filename: 'ril_remin_bom.txt', label: 'RIL Remin BOM — Engineering Review', description: 'BOM for engineering analysis — MOC specs (FRP, SS304L, SS316L, CPVC), equipment sizing, LSF internals design, PLC/instrumentation architecture, piping material classes', path: '/sample-data/presales/ril_remin_bom.txt', fileType: 'txt' },
  ],
  'commercial-legal': [
  ...
  'project-planning': [
    ...
    { filename: 'ril_remin_bom.txt', label: 'RIL Remin BOM — Planning Reference', description: 'Bill of Materials for resource planning — 632 items with lead times (30–180 days), work order references, procurement sequencing across 10 categories', path: '/sample-data/presales/ril_remin_bom.txt', fileType: 'txt' },
  ],
  'procurement-mfg': [
    ...
    { filename: 'ril_remin_bom.txt', label: 'RIL Remin BOM — Procurement View', description: 'Full procurement BOM — 632 items with WO refs, lead times (motors 90d, valves 60-120d, equipment 180d), vendor packages, material specs for sourcing', path: '/sample-data/presales/ril_remin_bom.txt', fileType: 'txt' },
    { filename: 'ril_remin_bom.csv', label: 'RIL Remin BOM (Raw Data)', description: 'Complete hierarchical BOM CSV — item codes, quantities, UOM, extended quantities, supply types, effectivity dates for procurement analysis and MRP', path: '/sample-data/presales/ril_remin_bom.csv', fileType: 'csv' },
  ],
  commissioning: [
    ...
    { filename: 'ril_remin_bom.txt', label: 'RIL Remin BOM — Commissioning Spares', description: 'BOM with spares manifest — K02 bought-out spares, K03 valve seal kits, K04 media spares, spare parts for agitators/pumps/CO2/lime systems for commissioning readiness', path: '/sample-data/presales/ril_remin_bom.txt', fileType: 'txt' },
  ],
